...
class PersonView extends React.Component {
            ...
            .then(res => {
                if (res.status) {
                    this.setState({
                        ...
                        activeHomeId: activeHomeId ? activeHomeId : res.data.person.homes.length ? res.data.person.homes[0].id : null,
                        personHomes: {},
                    });
                    if (res.data.person.homes.length) {
                        res.data.person.homes.map((item, index) => {
                            axios.get(config.apiURL + `api/v1/homes/${item.id}`).then(res => {
                                if (res.status) {
                                    let personHomes = this.state.personHomes;
                                    personHomes[item.id] = res.data.home;
                                    this.setState({
    ...
    getHomeDetailsById = homeId => {
        ...
        if (!this.state.personHomes[homeId]) return;

        let home = this.state.personHomes[homeId];
    ...
    renderTableData = (homeId) => {
        let data = [];
        let tabId = this.state.activeTableTab;

        if (this.state.personHomes[homeId] && tabId === 0) {
            if (this.state.personHomes[homeId].products?.length) {
                if (this.state.personHomes[homeId].products[0]?.services) {
                    data = this.state.personHomes[homeId].products[0]?.services
                }
            }
        }
        else if (this.state.personHomes[homeId] && tabId === 1) {
            data = this.state.personHomes[homeId].transactions
        }
        else if (this.state.personHomes[homeId] && tabId === 0) {
            data = this.state.personHomes[homeId].charging
        };
        ...
        return (
            <>
                                                    ...
                                                    <Table borderless>
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    {
                                                                        this.state.personHomes[item.id] &&
                                                                            this.state.personHomes[item.id].products?.length ?
                                                                            this.state.personHomes[item.id].products[0].name
                                                                            :
                                                                            ''
                                                                    }
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    {
                                                                        this.state.personHomes[item.id] ?
                                                                            this.state.personHomes[item.id]?.port?.card?.hardware?.area?.name
                                                                            :
                                                                            ''
                                                                    }
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    {
                                                                        this.state.personHomes[item.id] ?
                                                                            this.state.personHomes[item.id].port?.card?.hardware?.name
                                                                            :
                                                                            ''
                                                                    }
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td>Avadanlığın MAC adresi</td>
                                                                <td>
                                                                    {
                                                                        this.state.personHomes[item.id] ?
                                                                            this.state.personHomes[item.id].port?.card?.hardware?.mac
                                                                            :
                                                                            ''
                                                                    }
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    {
                                                                        this.state.personHomes[item.id] ?
                                                                            this.state.personHomes[item.id].port?.card?.name
                                                                            :
                                                                            ''
                                                                    }
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    {
                                                                        this.state.personHomes[item.id] ?
                                                                            this.state.personHomes[item.id].port?.name
                                                                            :
                                                                            ''
                                                                    }
                                                                </td>
                                                    ...
                                                    <div className="d-flex mb-4">
                                                        ...
                                                        </Button>
                                                        {
                                                            ...
                                                            <Button
                                                                ...
                                                                onClick={() => {
                                                                    if (this.state.personHomes[item.id]) {
                                                                        this.getAllProductList(this.state.personHomes[item.id].products.map(x => x.id));
                                                                        this.toggleAddProductModal();
                                                                    };
                                                                }}
                                                            >
                                                    ...
                                                    </div>
                                                    {
                                                        this.state.personHomes[item.id] ?
                                                            <BootstrapTable
                                                                ...
                                                                keyField='id'
                                                                {...tableConfig}
                                                                data={this.renderTableData(item.id)}
                                                                columns={
                                    ...
                                    <ModalBody>
                                        ...
                                        </div>
                                        {
                                            ...
                                            <div className="row pt-2">
                                                ...
                                                <div className="col-md-6 mb-4">
                                                    <Label for="card" className="font-weight-bold">Kart</Label>
                                                    <Select
                                                        id="card"
                                                        placeholder="Seç"
                                                        isDisabled={!this.state.selectedArea}
                                                ...
                                                {/* <div className="col-md-6 mb-4">
                                                    <Label for="up" className="font-weight-bold">IP address</Label>
                                                    <Input
                                                        name="ip"
                ...
                <Modal
                    size="md"
                    centered
                    isOpen={this.state.isOpenAddProductModal}
                ...
                >
                    ...
                    <ModalBody>
                        <div className="row pt-2">
                            ...
                            {/*<div className="col-md-6 mb-4">*/}
                            {/*    <Label for="started_at" className="font-weight-bold">Başlama tarixi</Label>*/}
                            {/*    <Input*/}
                            {/*        id='started_at'*/}
                            {/*        type='date'*/}
                            {/*        onChange={e => {*/}
                            {/*            let product = this.state.selectedNewProduct;*/}
                            {/*            product['started_at'] = e.target.value;*/}
                            {/*            this.setState({ selectedNewProduct: product });*/}
                            {/*        }}*/}
                            {/*    />*/}
                            {/*</div>*/}
                            {/*<div className="col-md-6 mb-4">*/}
                            {/*    <Label for="ended_at" className="font-weight-bold">Bitmə tarixi</Label>*/}
                            {/*    <Input*/}
                            {/*        id='ended_at'*/}
                            {/*        type='date'*/}
                            {/*        onChange={e => {*/}
                            {/*            let product = this.state.selectedNewProduct;*/}
                            {/*            product['ended_at'] = e.target.value;*/}
                            {/*            this.setState({ selectedNewProduct: product });*/}
                            {/*        }}*/}
                            {/*    />*/}
                            {/*</div>*/}
