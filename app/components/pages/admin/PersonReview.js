                                        ...
                                        <div className="col-md-6 mb-4">
                                            ...
                                            <Input
                                                ...
                                                defaultValue={
                                                    ...
                                                    (person.father_name ? person.father_name : '')
                                                }
                                            />
                                        </div>
                                        <div className="col-md-6 mb-4">
                                            ...
                                            <Input
                                                disabled
                                                defaultValue={person?.pin}
                                            />
                                        </div>
                                        <div className="col-md-6 mb-4">
                                            <Label className='font-weight-bold'>Ərazi</Label>
                                            <Input
                                                disabled
                                                defaultValue={data?.port?.card?.hardware?.area?.name}
                                            />
                                        </div>
                                        <div className="col-md-6 mb-4">
                                            <Label className='font-weight-bold'>Avadanlıq</Label>
                                            <Input
                                                disabled
                                                defaultValue={data?.port?.card?.hardware?.name}
                                            />
                                        </div>
                                        <div className="col-md-6 mb-4">
                                            <Label className='font-weight-bold'>Kart</Label>
                                            <Input
                                                disabled
                                                defaultValue={data?.port?.card?.name}
                                            />
                                        </div>
                                        <div className="col-md-6 mb-4">
